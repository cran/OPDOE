#(size n.three way nested. model 1 b)
# Section 3.4.2.1 test factor B in A

# Three way nested classification. Model I
# Factor A, B and C are fixed. Determining n
# Testing hypothesis about factor B
size_n.three_way_nested.model_1_b <-  function(alpha, beta, delta, a, b, c, cases)
{
	n <- 2
	dfn <- a*(b-1)
	dfd <- a*b*c*(n-1)
...
# example
# size.3_4_2_1.test_factor_BinA(0.05, 0.1, 0.5, 6, 5, 4, "maximin")
# size.3_4_2_1.test_factor_BinA(0.05, 0.1, 0.5, 6, 5, 4, "minimin")
